...
public class RollerCoaster {
	...
	if( heightAsInt >= 48 ) {JOptionPane.showMessageDialog(null, "You are tall enough to ride! Enjoy!"); }
	else {JOptionPane.showMessageDialog(null, "Sorry, but you need to be 42 inches to ride,pal.\n But you can ride with someone else.");}
